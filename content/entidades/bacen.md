...
status: revisado
sigla: BCB
nome_completo: Banco Central do Brasil
natureza: Autarquia federal especial (vinculada ao Ministério da Fazenda, com autonomia operacional)
competencia:
  - Garantir a estabilidade do poder de compra da moeda nacional (controle da inflação).
  - Zelar por um sistema financeiro estável, seguro e eficiente.
  - Executar as políticas monetária, cambial, de crédito e de relações financeiras com o exterior.
  - Regular e supervisionar as instituições financeiras e demais entidades autorizadas a funcionar.
  - Emitir papel-moeda e moeda metálica nas condições fixadas pelo Conselho Monetário Nacional (CMN).
  - Regular, autorizar e supervisionar os prestadores de serviços de ativos virtuais (criptoativos) e arranjos de pagamento (como o Pix).
