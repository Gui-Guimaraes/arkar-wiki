...
numero: 15
ano: 2011
ementa: "Estabelece os princípios e requisitos para a forma como o adquirente reconhece e mensura ativos, passivos, participações não controladoras e o ágio por expectativa de rentabilidade futura (goodwill) em uma combinação de negócios."
vigencia_inicio: 2012-01-01
vigencia_fim:
url_oficial: "http://cpc.org.br"
revoga: ["CPC 15 original"]
revogada_por:
alterada_por: []
aplica_a: ["Companhias abertas", "Sociedades de grande porte", "Empresas em processos de fusões e aquisições (M&A)", "Auditores independentes"]
