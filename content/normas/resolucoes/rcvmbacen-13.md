...
numero: 13
ano: 2024
ementa: "Dispõe sobre o Cadastro de Acesso de Investidores (CAI), como alternativa à observância do conteúdo previsto na Resolução CVM 50 e na regulação do Banco Central para investidores não residentes em mercados regulamentados."
...
revogada_por:
alterada_por: []
aplica_a: ["Investidores não residentes (estrangeiros)", "Custodiantes locais", "Corretoras e distribuidoras", "Instituições de câmbio"]
