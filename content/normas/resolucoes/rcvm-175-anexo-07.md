...
numero: 175
ano: 2022
ementa: "Dispõe sobre as regras específicas para os fundos mútuos de privatização – FGTS (FMP-FGTS), estabelecendo os critérios de constituição, limites de carteira e governança aplicáveis a essa classe de fundo."
vigencia_inicio: 2023-10-02
vigencia_fim:
url_oficial: "https://cvm.gov.br"
revoga: ["Instrução CVM 39"]
revogada_por:
alterada_por: ["Resolução CVM 184"]
aplica_a: ["Administradores fiduciários", "Gestores de recursos", "Instituições administradoras de FI-FGTS", "Investidores detentores de contas do FGTS"]
verificado_em: 2026-07-25
verificado_por: ""
fontes:
  - "Comissão de Valores Mobiliários - Portal de Normas: https://cvm.gov.br"
aliases: [Anexo VII da CVM 175, Regulamento FMP-FGTS, Fundos Mútuos de Privatização]
tags: [norma, fundos-de-investimento, fgts, privatizacao, mercado-de-capitais]
publish: true
---
