...
numero: 23
ano: 2021
ementa: "Dispõe sobre a atividade de analista de valores mobiliários no âmbito do mercado de valores mobiliários."
vigencia_inicio: 2021-04-01
vigencia_fim:
url_oficial: "https://www.gov.br/cvm/pt-br"
revoga: ["Instrução CVM 598"]
revogada_por:
alterada_por: ["Resolução CVM 168"]
aplica_a: ["Analistas de valores mobiliários (Pessoa Física e Jurídica)", "Researchs independentes", "Bancos de investimento e corretoras", "Produtores de relatórios de análise"]
...
* **Analista atuar como operador ou coletor de ordens:** O profissional credenciado pela 23 intermediar ou boletar ordens de clientes junto a mesas de corretoras, desviando-se de suas atribuições estritas de estudo técnico e emissão de opiniões informacionais.
...
* **Resolução CVM 19 (Consultoria de Valores Mobiliários):** Normas vizinhas de escopo informacional. Consultores cadastrados pela 19 utilizam frequentemente os relatórios técnicos dos analistas regidos pela 23 como matéria-prima para formular suas carteiras personalizadas de varejo.
