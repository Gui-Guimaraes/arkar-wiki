---
title: "Ofício-Circular nº 2/2025/CVM/SIN (Diretrizes Anuais para Investidores Institucionais)"
titulo: "Ofício-Circular nº 2/2025/SIN"
tipo: norma
status: revisado
orgao: Comissão de Valores Mobiliários (CVM) - Superintendência de Supervisão de Investidores Institucionais (SIN)
numero: 2
ano: 2025
ementa: "Presta esclarecimentos e orientações anuais gerais sobre os procedimentos operacionais, obrigações periódicas e rotinas de fiscalização aplicáveis aos administradores e gestores de carteiras de fundos de investimento para o exercício de 2025."
vigencia_inicio: 2025-01-31
vigencia_fim:
url_oficial: "https://cvm.gov.br"
revoga: []
revogada_por:
alterada_por: []
aplica_a: ["Administradores fiduciários", "Gestores de recursos (Assets)", "Custodiantes de fundos", "Intermediários financeiros"]
...
tags: [norma, ofio-circular, fundos-de-investimento, obrigações-periódicas, compliance, cvm]
publish: true
---

O **Ofício-Circular nº 2/2025/CVM/SIN** consiste no guia anual consolidado de orientações técnicas e procedimentais emitido pela Superintendência de Supervisão de Investidores Institucionais da CVM para o exercício de 2025. Publicado rotineiramente no início de cada ano social, este documento funciona como o principal manual de conformidade contínua (*ongoing compliance*) para os participantes do mercado de fundos, organizando os calendários de envio de dados, interpretando exigências cadastrais e explicitando as áreas prioritárias de fiscalização eletrônica que a autarquia adota sobre o estoque de condomínios de investimento.

## Escopo

O escopo do Ofício-Circular Anual nº 2/2025/SIN consolida os entendimentos operacionais indispensáveis para a retaguarda dos veículos de investimento:
* **Cronograma Unificado de Envio 2025:** Fixação exata de datas e prazos de corte para o envio de balancetes, informes diários, mensais e anuais exigidos no ecossistema de fundos.
...
* **Ativação de Calendários de Backoffice:** Os controladores e custodiantes locais utilizam as tabelas do ofício para parametrizar seus cronogramas internos de disparo de dados automatizados, mitigando riscos de atraso de informes.
* **Bloqueio de Multas Cominatórias:** O cumprimento rigoroso dos prazos listados no documento evita a geração automática de multas cominatórias diárias emitidas de forma sistêmica pelos servidores computacionais da autarquia.
...
* **Atrasar o envio de Informes Diários culpando a Clearing:** Justificar o atraso sistemático no envio de lâminas ou informes diários por oscilações na rede ou na B3, visto que o ofício emite alertas de que a responsabilidade final pelo envio de dados no prazo é indelegável do administrador fiduciário.
...
* **Ofício-Circular Conjunto nº 1/2023/CVM/SIN/SSE:** Atuam de forma casada; o Ofício 01/2023 SIN/SSE dita as regras extraordinárias de *transição estrutural* para a Resolução CVM 175, enquanto o Ofício 02/2025/SIN foca no *calendário ordinário contínuo* de obrigações eletrônicas da carteira para o ano de 2025.
