...
numero: 7
ano: 2024
ementa: "Presta esclarecimentos aos administradores, gestores e distribuidores de fundos de investimento sobre os prazos de transição, limites para manutenção de arranjos de remuneração antigos e a segregação de taxas sob a égide da Resolução CVM nº 175."
vigencia_inicio: 2024-07-15
vigencia_fim:
url_oficial: "https://cvm.gov.br"
revoga: []
revogada_por:
alterada_por: []
aplica_a: ["Administradores fiduciários", "Gestores de recursos (Assets)", "Distribuidores de produtos de investimento", "Plataformas de investimento"]
...
tags: [norma, ofio-circular, fundos-de-investimento, rcvm-175, distribuicao, rebate, compliance]
publish: true
---
