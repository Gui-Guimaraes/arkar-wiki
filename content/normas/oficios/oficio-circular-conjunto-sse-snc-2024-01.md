...
numero: 1
ano: 2024
ementa: "Presta orientações conjuntas sobre a elaboração de demonstrações contábeis, aplicação de normas de auditoria independente e consolidação de dados de patrimônios separados no mercado de securitização."
vigencia_inicio: 2024-02-15
vigencia_fim:
url_oficial: "https://cvm.gov.br"
revoga: []
revogada_por:
alterada_por: []
aplica_a: ["Companhias Securitizadoras", "Auditores Independentes", "Contadores corporativos", "Agentes fiduciários"]
...
tags: [norma, ofio-circular, contabilidade, auditoria, securitizacao, cpc, compliance]
publish: true
---
