...
numero: 2
ano: 2024
ementa: "Presta esclarecimentos e orientações anuais gerais sobre os procedimentos operacionais, obrigações periódicas e rotinas de fiscalização aplicáveis aos administradores e gestores de carteiras de fundos de investimento para o exercício de 2024."
vigencia_inicio: 2024-01-31
vigencia_fim:
...
aliases: [Ofício-Circular Anual SIN 2024, OC SIN 02/24, Guia de Rotinas SIN 2024]
tags: [norma, ofio-circular, fundos-de-investimento, obrigações-periódicas, compliance, cvm]
publish: true
---

O **Ofício-Circular nº 2/2024/CVM/SIN** consiste no guia anual consolidado de orientações técnicas e procedimentais emitido pela Superintendência de Supervisão de Investidores Institucionais da CVM para o exercício de 2024. Publicado rotineiramente no início de cada ano social, este documento funciona como o principal manual de conformidade contínua (*ongoing compliance*) para os participantes do mercado de fundos, organizando os calendários de envio de dados, interpretando exigências cadastrais e explicitando as áreas prioritárias de fiscalização eletrônica sob o contexto de implantação da Resolução CVM nº 175.

## Escopo

O escopo do Ofício-Circular Anual nº 2/2024/SIN consolida os entendimentos operacionais indispensáveis para a retaguarda dos veículos de investimento:
* **Cronograma Unificado de Envio 2024:** Fixação exata de datas e prazos de corte para o envio de balancetes, informes diários, mensais e anuais exigidos no ecossistema de fundos.
...
* **Ofício-Circular Conjunto nº 1/2023/CVM/SIN/SSE:** Atuam de forma casada; o Ofício 01/2023 SIN/SSE dita as regras extraordinárias de *transição estrutural* para a Resolução CVM 175, enquanto o Ofício 02/2024/SIN foca no *calendário ordinário contínuo* de obrigações eletrônicas da carteira para o ano corrente.
