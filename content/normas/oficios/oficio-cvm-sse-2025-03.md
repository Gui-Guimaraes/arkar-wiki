...
numero: 3
ano: 2025
ementa: "Presta esclarecimentos e orientações complementares aos participantes do mercado sobre procedimentos operacionais, tratamento de garantias reais e validação de lastros em ofertas de certificados de recebíveis (CRI e CRA) sob a égide da Resolução CVM nº 160 para o exercício de 2025."
vigencia_inicio: 2025-03-12
vigencia_fim:
...
O **Ofício-Circular nº 3/2025/CVM/SSE** é uma diretriz técnica orientadora emitida pela Superintendência de Securitização e Investimentos Estruturados da CVM para o exercício de 2025. O documento visa detalhar os procedimentos para a validação empírica e formal de lastros, bem como o tratamento de garantias reais e fiduciárias atreladas a ofertas de Certificados de Recebíveis Imobiliários (CRI) e do Agronegócio (CRA), consolidando o nível de exigência de diligência prévia cobrado do mercado.

## Escopo

O escopo do Ofício-Circular nº 3/2025/SSE normatiza as rotinas de auditoria de lastros e estruturação de garantias imobiliárias e rurais:
...
* **Misturar Recursos de Amortizações com o Caixa Geral:** Permitir o trâmite temporário de recebíveis brutos de uma emissão de CRA pela conta corrente matriz de despesas da holding securitizadora antes do repasse definitivo para a conta do patrimônio de afetação.
...
* **Resolução CVM 160 (Novo Marco das Ofertas Públicas):** Norma federal mãe. O Ofício 03/2025/SSE funciona como o manual técnico de retaguarda para assegurar que a *due diligence* do lastro dê legitimidade ao uso das esteiras rápidas automáticas da 160.
* **Ofício-Circular nº 2/2025/CVM/SSE (Diretrizes Temáticas):** Atuam de forma paralela; o Ofício 02/2025 foca nos *ajustes e resoluções de problemas cadastrais das telas*, enquanto o Ofício 03/2025 detalha as *diretrizes substantivas de lastros e garantias reais*.
