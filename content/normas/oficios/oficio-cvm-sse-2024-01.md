---
title: "Ofício-Circular nº 1/2024/CVM/SSE (Diretrizes Anuais para Securitização)"
titulo: "Ofício-Circular nº 1/2024/CVM/SSE"
tipo: norma
status: revisado
orgao: Comissão de Valores Mobiliários (CVM) - Superintendência de Securitização e Investimentos Estruturados (SSE)
numero: 1
ano: 2024
ementa: "Presta esclarecimentos e orientações aos participantes do mercado sobre procedimentos cadastrais, rotinas periódicas e obrigações informacionais no âmbito do mercado de securitização e investimentos estruturados para o exercício de 2024."
...
revogada_por:
alterada_por: []
aplica_a: ["Companhias Securitizadoras", "Emissores de certificados de recebíveis (CRI e CRA)", "Coordenadores de ofertas estruturadas", "Agentes fiduciários"]
...
tags: [norma, ofício-circular, securitização, obrigações-periódicas, fundos-estruturados, compliance]
publish: true
---

O **Ofício-Circular nº 1/2024/CVM/SSE** consiste no guia anual consolidado de orientações e rotinas procedimentais emitido pela Superintendência de Securitização e Investimentos Estruturados da CVM para o exercício de 2024. O documento concentra os prazos de reporte de dados, atualizações de cadastros de emissores e os focos de fiscalização eletrônica que a área técnica adotará sobre as companhias securitizadoras e ofertas de Certificados de Recebíveis (CRIs e CRAs), funcionando como o principal manual de conformidade contínua (*ongoing compliance*) do setor de securitização pós-reforma.

## Escopo

O escopo do Ofício-Circular Anual nº 1/2024/SSE organiza a esteira de obrigações contínuas aplicáveis ao mercado de ativos securitizados:
* **Calendário de Obrigações Periódicas:** Fixação exata das datas de corte para o envio de demonstrações financeiras, relatórios de agentes fiduciários e informes trimestrais de patrimônios separados de 2024.
...
* **Ofício-Circular nº 7/2023/CVM/SSE (Diretrizes de Securitização):** Relação de continuidade; o Ofício 07/2023/SSE fixou as bases de *transição e interpretação conceitual* pós-reforma estrutural, enquanto o Ofício 01/2024/SSE dita o *calendário operacional ordinário* do ano de 2024.
